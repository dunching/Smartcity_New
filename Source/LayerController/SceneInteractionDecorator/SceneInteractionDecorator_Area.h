 ...
 * 
 */
class LAYERCONTROLLER_API FArea_Decorator : public FDecoratorBase
{
public:
	GENERATIONCLASSINFO(
	                    FArea_Decorator,
 ...
 * 选中“整楼”区域
 */
class LAYERCONTROLLER_API FViewTower_Decorator : public FArea_Decorator
{
public:
	GENERATIONCLASSINFO(
 ...
 * 选中“整楼”区域
 */
class LAYERCONTROLLER_API FViewPeriphery_Decorator : public FArea_Decorator
{
public:
	GENERATIONCLASSINFO(
 ...
 * 楼层 展开
 */
class LAYERCONTROLLER_API FSplitFloor_Decorator : public FDecoratorBase
{
public:
	GENERATIONCLASSINFO(
 ...
 * 选中“单楼”区域
 */
class LAYERCONTROLLER_API FFloor_Decorator : public FArea_Decorator
{
public:
	GENERATIONCLASSINFO(
	                    FFloor_Decorator,
 ...
 * 选中“单楼”区域
 */
class LAYERCONTROLLER_API FViewDevice_Decorator : public FArea_Decorator
{
public:
	GENERATIONCLASSINFO(
...
class LAYERCONTROLLER_API FViewSpace_Decorator : public FArea_Decorator
{
public:
	GENERATIONCLASSINFO(
...
class LAYERCONTROLLER_API FViewSpecialArea_Decorator : public FArea_Decorator
{
public:
	GENERATIONCLASSINFO(
