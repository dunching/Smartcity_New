...
namespace TourProcessor
{
	 ...
	 * 漫游的状态
	 */
	class LAYERCONTROLLER_API FViewElevatorProcessor : public FTourProcessor
	{
	private:
		GENERATIONCLASSINFO(FViewElevatorProcessor, FTourProcessor);

	public:
		using FOwnerPawnType = ATourPawn;

		FViewElevatorProcessor(FOwnerPawnType* CharacterPtr);
