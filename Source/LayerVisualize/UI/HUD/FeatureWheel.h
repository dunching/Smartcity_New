...
struct LAYERVISUALIZE_API FFeaturesItem
{
	GENERATED_BODY()
...
UCLASS()
class LAYERVISUALIZE_API UFeatureItem : public UUserWidget
{
	GENERATED_BODY()
...
UCLASS()
class LAYERVISUALIZE_API UFeatureWheel : public UHoverWidgetReBase
{
	GENERATED_BODY()
