...
UCLASS()
class LAYERVISUALIZE_API UGT_SwitchSceneElementManagger_Lighting_Display : public UGT_RuntimeTask
{
	GENERATED_BODY()
...
UCLASS()
class LAYERVISUALIZE_API UGT_SwitchSceneElementManagger_Lighting_Hide : public UGT_RuntimeTask
{
	GENERATED_BODY()
 ...
 */
UCLASS()
class LAYERVISUALIZE_API ASceneElementManagger_Lighting :
