...
#include "ComputerMark.generated.h"
...
UCLASS()
class LAYERVISUALIZE_API UComputerMarkWDGHelper : public UUserWidget
{
	GENERATED_BODY()
 ...
 */
UCLASS()
class LAYERVISUALIZE_API AComputerMark : public AActor
{
	GENERATED_BODY()
