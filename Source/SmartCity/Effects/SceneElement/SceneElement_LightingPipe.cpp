#include "SceneElement_LightingPipe.h"
...
ASceneElement_LightingPipe::ASceneElement_LightingPipe(
...
void ASceneElement_LightingPipe::BeginPlay()
{
	Super::BeginPlay();
}

void ASceneElement_LightingPipe::ReplaceImp(
	AActor* ActorPtr,
...
void ASceneElement_LightingPipe::Merge(
...
void ASceneElement_LightingPipe::SwitchInteractionType(
...
void ASceneElement_LightingPipe::EntryFocusDevice()
{
...
void ASceneElement_LightingPipe::QuitFocusDevice()
{
	Super::QuitFocusDevice();
}

void ASceneElement_LightingPipe::EntryViewDevice()
{
	Super::EntryViewDevice();
}

void ASceneElement_LightingPipe::QuitViewDevice()
{
	Super::QuitViewDevice();
}

void ASceneElement_LightingPipe::EntryShowDevice()
{
...
void ASceneElement_LightingPipe::EntryShoweviceEffect()
{
...
void ASceneElement_LightingPipe::QuitShowDeviceEffect()
{
	Super::QuitShowDeviceEffect();
}

void ASceneElement_LightingPipe::QuitAllState()
{
	Super::QuitAllState();
...
void ASceneElement_LightingPipe::SwitchLight(
	int32 Intensity,
	int32 Temperature,
...
void ASceneElement_LightingPipe::SetEmissiveValue(
	int32 Value,
	int32 Temperature,
	const FLinearColor& LightColor
	)
