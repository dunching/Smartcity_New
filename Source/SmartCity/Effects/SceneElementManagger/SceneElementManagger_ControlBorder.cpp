#include "SceneElementManagger_ControlBorder.h"
...
ASceneElementManagger_ControlBorder::ASceneElementManagger_ControlBorder(
...
void ASceneElementManagger_ControlBorder::Merge(
...
TArray<TObjectPtr<UGameplayTaskBase>> ASceneElementManagger_ControlBorder::SwitchInteractionType(
...
void ASceneElementManagger_ControlBorder::UpdateExtensionParamMap(
...
TArray<TObjectPtr<UGameplayTaskBase>> ASceneElementManagger_ControlBorder::SwitchFloor(
	const FSceneElementConditional& ConditionalSet
	) const
{
