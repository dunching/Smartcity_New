...
const ECollisionChannel AreaLimit_Object = ECollisionChannel::ECC_GameTraceChannel1;
const ECollisionChannel Space_Object = ECollisionChannel::ECC_GameTraceChannel2;
...
const ECollisionChannel ECC_StreetObj = ECollisionChannel::ECC_GameTraceChannel7;
